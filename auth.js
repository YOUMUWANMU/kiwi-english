...
window.KIWI = (function () {
  ...
  const STAGES = [
    ...
    { id: 2, months: 'M3-4',   days: 60, name: '开口生存',     desc: '30 个生存场景能开口',              cefr: 'A2',      lexile: '400-550L',
      gate: { listening: 32, speaking: 24, writing: 6,  reading: 8,  minListeningAcc: 80, minWritingScore: 7 } },
    { id: 3, months: 'M5-7',   days: 90, name: '课堂跟上',     desc: '体育 / 美术 / 音乐课能跟上',       cefr: 'A2→B1',   lexile: '500-700L',
      gate: { listening: 48, speaking: 32, writing: 10, reading: 6,  minListeningAcc: 82, minWritingScore: 7 } },
    { id: 4, months: 'M8-9',   days: 60, name: '学科入门',     desc: '科学 / 数学课堂用语理解',          cefr: 'B1',      lexile: '650-800L',
      gate: { listening: 40, speaking: 40, writing: 10, reading: 1,  minListeningAcc: 82, minWritingScore: 7 } },
    { id: 5, months: 'M10-11', days: 60, name: '写作起步',     desc: '日记 / 邮件 / 实验报告',           cefr: 'B1',      lexile: '750-900L',
      gate: { listening: 32, speaking: 32, writing: 14, reading: 1,  minListeningAcc: 85, minWritingScore: 7.5 } },
    { id: 6, months: 'M12-13', days: 60, name: '阅读进阶',     desc: 'NZ 青少年小说、教材选段',          cefr: 'B1+',     lexile: '850-1000L',
      gate: { listening: 32, speaking: 32, writing: 10, reading: 1,  minListeningAcc: 85, minWritingScore: 7.5 } },
    { id: 7, months: 'M14-16', days: 90, name: '学术综合',     desc: '议论文 + TED-Ed + Year 9 教材',    cefr: 'B1+→B2',  lexile: '1000-1150L',
      gate: { listening: 48, speaking: 48, writing: 14, reading: 1,  minListeningAcc: 85, minWritingScore: 8 } },
    { id: 8, months: 'M17-18', days: 60, name: 'Year 10 冲刺', desc: '达到 NZ Year 10 母语同龄人水平',    cefr: 'B2',      lexile: '1100-1250L',
      gate: { listening: 32, speaking: 32, writing: 8,  reading: 1,  minListeningAcc: 88, minWritingScore: 8 } },
  ];
  // ====== /STAGES ======
